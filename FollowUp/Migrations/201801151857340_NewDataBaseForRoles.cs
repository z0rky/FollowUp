namespace FollowUp.Migrations
{
    ...
    public partial class NewDataBaseForRoles : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        DatumVraag = c.DateTime(nullable: false),
                    })
                .PrimaryKey(t => t.Id)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.ExtraInfoes", "IssueId", "dbo.Issues");
            ...
            DropIndex("dbo.ExtraInfoes", new[] { "IssueId" });
